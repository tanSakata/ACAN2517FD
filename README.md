original : https://github.com/pierremolinaro/acan2517FD.git
inspired : https://github.com/TNCT-Mechatech/acan2517FD.git
...
void setup () {
 ...
 // Arbitration bit rate: 125 kbit/s, data bit rate: 500 kbit/s
  ...
  const uint32_t errorCode = can.begin (settings, []$00A0{ can.isr () ; }) ;
  if (0 == errorCode) {
